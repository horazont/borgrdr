...
fn empty_bytes_hashmap() -> HashMap<Bytes, Option<Bytes>> {
	HashMap::new()
}
...
pub struct ArchiveItem {
	...
	xattrs: HashMap<Bytes, Option<Bytes>>,
...
impl ArchiveItem {
	...
	pub fn xattrs(&self) -> &HashMap<Bytes, Option<Bytes>> {
		&self.xattrs
	}

	pub fn into_xattrs(self) -> HashMap<Bytes, Option<Bytes>> {
		self.xattrs
	}
